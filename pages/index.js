...
<body style="background: #038CCF" class="cs-HTML is-theme-classic" role="application">
	<!-- 360 -->
	<script>
	...
	<script>
      ...
      aid: 'auth0|596f5e1b5fd3c54c71fa179b',
      cid: '51b10ef3',
      playerVersion: '3.17.16188.0',
	...
	<div class="mobile-load-title-overlay">
		<div class="mobile-load-title">Basic Electricals</div>
	</div>
	<script>
	...
	<div class="mobile-chrome-warning">
		<div class="mobile-chrome-warning-btn">
			<svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink"
				preserveAspectRatio="none" x="0px" y="0px" width="107px" height="78px" viewBox="0 0 107 78">
            ...
            L 12.05 15.85 0 31.4 8.3 31.4 8.3 54 15.25 54 15.25 31.4 24.1 31.4 Z" />
				...
				<path id="mobile-chrome-warning-hand" stroke="white" stroke-width="2" stroke-linejoin="round"
...
export default function Home() {
  ...
  return (
    <div className={styles.container}>
      ...
      <iframe src={`https://edison-scorm.b-cdn.net/scorm/index_lms.html`} style={{height: '1000px', width: '1000px'}}>
        </iframe>
    </div>
  )
}